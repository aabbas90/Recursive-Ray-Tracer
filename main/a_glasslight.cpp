...
void renderCornellboxA(float scale, const char* filename) {
	...
	// Material* mat_stones = new PhongMaterial(bluetex, 20.0f);

    // MatLib* matlib = new MatLib;
    // matlib->insert(std::pair<std::string, Material*>("None", mat_stones)); 

    // BVH* scene = new BVH(false); //uncomment this
...
void a_glasslight() {
    renderCornellboxA(0.001f, "1_glasslight.png");
